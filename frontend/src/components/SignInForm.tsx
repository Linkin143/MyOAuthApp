      ...
      <div className="flex flex-col md:flex-row max-w-5xl w-full bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="hidden md:block w-1/2 bg-gradient-to-br from-emerald-500 to-emerald-700 p-10 text-white">
          <div className="h-full flex flex-col justify-between">
            <div>
              <h2 className="text-3xl font-bold mb-6">Welcome Back to Our Community!</h2>
              <p className="text-emerald-100 mb-8 text-lg">
                Sign in to access your personalized dashboard and continue your journey with us.
              </p>
              <ul className="space-y-4">
                {['Personalized Experience', 'Secure Access', 'Real-time Updates', 'Premium Features'].map(
                  (benefit, index) => (
            ...
            <div className="mt-auto">
              <div className="p-4 bg-green-950 bg-opacity-10 rounded-lg backdrop-blur-sm">
                <p className="text-emerald-100 italic">
                  "The features and support on this platform are unmatched. It has become an essential part of my daily workflow!"
                </p>
                <div className="mt-4 flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-xs text-emerald-200">Software Engineer</p>
                  </div>
                </div>
              </div>
            </div>
